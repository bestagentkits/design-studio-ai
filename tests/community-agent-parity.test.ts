...
const expectedCommunitySchemaKeys=['POST /api/community/preflight','POST /api/community/listings','POST /api/community/listings/{id}/releases','POST /api/community/listings/{id}/unlist','POST /api/community/listings/{id}/remix','PUT /api/community/me/profile','POST /api/community/me/profile/generate','POST /api/community/listings/{id}/reports','POST /api/community/moderation/reports/{id}/resolve','POST /api/community/moderation/collections','PUT /api/community/moderation/collections/{id}'];

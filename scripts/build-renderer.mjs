...
const dependencies = Object.fromEntries(Object.entries(pkg.dependencies).filter(([name]) => ['react', 'react-dom', 'antd', 'zod','three', 'perfect-freehand'].includes(name) || name.startsWith('@radix-ui/')));

...
const env: Bindings = {
  ...
  GITHUB_CONNECTOR_APP_ID: process.env.GITHUB_CONNECTOR_APP_ID,
  GITHUB_CONNECTOR_PRIVATE_KEY: process.env.GITHUB_CONNECTOR_PRIVATE_KEY,
  GITHUB_CONNECTOR_WEBHOOK_SECRET: process.env.GITHUB_CONNECTOR_WEBHOOK_SECRET,
  GOOGLE_CONNECTOR_CLIENT_ID: process.env.GOOGLE_CONNECTOR_CLIENT_ID,
  GOOGLE_CONNECTOR_CLIENT_SECRET: process.env.GOOGLE_CONNECTOR_CLIENT_SECRET,
